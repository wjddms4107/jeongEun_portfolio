...
export default function ProjectSection({ projects }: IProps) {
  ...
  return (
    <motion.div
      ...
      className="bg-white dark:bg-darkLightGray200 rounded-2xl shadow-lg p-5 lg:py-[30px] lg:pl-[30px] lg:my-12 md:w-auto"
    >
      <motion.h2 variants={variants} className="text-2xl lg:text-5xl font-extrabold mb-6">
        Projects (총 {projects?.length}개)
      </motion.h2>
      <h3 className="text-base lg:text-xl text-deepGray dark:text-darkDeepGray">
        총 {projects?.length}개의 프로젝트를 최신순으로 나열해놓았습니다. 기술스택, 프로젝트 소개 및
