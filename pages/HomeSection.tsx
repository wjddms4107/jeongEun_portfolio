...
export default function HomeSection(){
  const texts = ['이쁘게 개발하는 것을 좋아하는', '적응력이 뛰어나 협업에 자신있는', '성취 중독자', '노션에 정은표 개발사전을 만든'];
  const speed = 120;
  ...
  return (
    <>
      <div id="home" className="relative flex align-middle justify-between">
        <div className="w-3/5 items-center text-[50px] leading-[1.3] font-semibold text-deepGray m-auto">
          ...
          <div className="text-base mt-2">
            <div className="group cursor-pointer">
              <div>소개글 전체보기</div>
              <span className="opacity-0 group-hover:opacity-100" >'이쁘게 개발하는 것을 좋아하는', '적응력이 뛰어나 협업에 자신있는', '성취 중독자', '노션에 정은표 개발사전을 만든'</span>
            </div>  
          </div>
          ...
          <div className="absolute text-base cursor-pointer mt-2">
              <details>
                ...
                <div className="grid grid-cols-2 gap-3 max-h-[200px] w-[800px] mt-2 space-y-2 overflow-y-scroll">
                  ...
                  <div className="pl-2 border-l border-lightGray200 border-dashed">
                    <div className="relative right-[9px] border-l border-purple pl-2">2. '적응력이 뛰어나 협업에 자신있는'</div>
                  ...
                  <div className="pl-2 border-l border-lightGray200 border-dashed">
                    <div className="relative right-[9px] border-l border-purple pl-2">3. '성취 중독자'</div>
